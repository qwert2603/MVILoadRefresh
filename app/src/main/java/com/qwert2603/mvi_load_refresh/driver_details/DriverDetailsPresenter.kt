...
class DriverDetailsPresenter(private val key: Long) : LRPresenter<Driver, DriverDetailsModel, DriverDetailsView>() {

    override fun initialModelSingle(): Single<Driver> = Single.just(DriversSource.DRIVERS)
